  ...
  return knex('byow').del()
    .then(function () {
      ...
      return knex('byow').insert([
        ...
        {id: 14, restaurant: 'Little Hanoi', category: 'Vietnamese', location: 'Cuba', price: 'Cheap and Cheerful', phone: '+64 4  4 928 8888'},
        ...
        {id: 23, restaurant: 'Phuthai Lanna', category: 'Thai', location: 'Mount Vic', price: 'In The Middle', phone: '+64 4 Phone: 04-'},
